...
const Team = () => {
    const teamMembers = [
        ...
        },
        {
            ...
            links:{ linkedinLink: "https://www.linkedin.com/in/ijaz-ul-haq-48a294167", scholarLink: "https://scholar.google.ca/citations?hl=en&user=TdaSaRgAAAAJ"}
        },
        {
            name: 'Awais Khan',
            imageSrc: awaisHeadshot,
            occupation: "PhD Student, CSI, Oakland", //'Awais Khan is currently pursuing a Doctor of Philosophy in Computer Science at the School of Engineering and Computer Science, Oakland University, Rochester, Michigan, USA. His research interests revolve around the captivating realm of speech processing, with a particular emphasis on topics like Deepfake Detection, Automatic Speaker Verification, and Anti-Spoofing. He aims to enhance security and combat emerging threats within voice-based technologies.',
            researchAreas:"Multimedia Forensics, DeepFake, Audio Spoofing.",
            links:{ linkedinLink: "https://www.linkedin.com/in/awais-khan-01620a14a", scholarLink: "https://scholar.google.ca/citations?hl=en&user=N3awCpYAAAAJ"}
        },
        {
            name: 'Muhammad Irfan',
            imageSrc: irfanHeadshot,
            occupation: "PhD Student, CSI, Oakland", //'Muhammad Irfan is currently pursuing a Doctor of Philosophy in Computer Science at the School of Engineering and Computer Science, Oakland University, Rochester, Michigan, USA. His research interests revolve around the captivating realm of speech processing, with a particular emphasis on topics like Deepfake Detection, Automatic Speaker Verification, and Anti-Spoofing. He aims to enhance security and combat emerging threats within voice-based technologies.',
            researchAreas:"Computer Vision, Machine Learning, Medical Image Analysis, Autonomous Driving.",
            links:{ linkedinLink: "https://www.linkedin.com/in/muhammad-irfan-1b0a4014a", scholarLink: "https://scholar.google.ca/citations?hl=en&user=MfhBA7EAAAAJ"}
        },
        {
            name: 'James Ryan',
            imageSrc: jjHeadshot,
            occupation: "PhD Student, CS, UFM-Flint", //'James Ryan is currently pursuing a Doctor of Philosophy in Computer Science at the School of Engineering and Computer Science, Oakland University, Rochester, Michigan, USA. His research interests revolve around the captivating realm of speech processing, with a particular emphasis on topics like Deepfake Detection, Automatic Speaker Verification, and Anti-Spoofing. He aims to enhance security and combat emerging threats within voice-based technologies.',
            researchAreas:"Cyber Security, Autonomous Driving.",
            links:{ linkedinLink: "https://www.linkedin.com/in/jjryan111/", scholarLink: ""}
        },
        {
            name: 'Muhammad Anas Raza',
            imageSrc: anasHeadshot,
            occupation: "PhD Student, CSI, Oakland", //'Anas fell in love with programming in 6th grade when he learned that my friend could develop the games he played on his PC. He attempted to create a Visual Basic application in high school. He adores reading, writing, thinking about, improving, and understanding programs, especially in Python. At SMILES Lab, He works in using Computer Vision techniques for multimedia forensics personal website: https://anasrz.com',
            researchAreas:"Computer Vision, Multimedia Forensics, DeepFake.",
            links:{ linkedinLink: "https://www.linkedin.com/in/memanasraza/", scholarLink: "", websiteLink:"https://anasrz.com"}
        },
        {
            name: 'Muhammad Umar Farooq',
            imageSrc: umarHeadshot,
            occupation: "PhD Student, CSI, Oakland", //'Muhammad Umar Farooq is currently pursuing a Doctor of Philosophy in Computer Science at the School of Engineering and Computer Science, Oakland University, Rochester, Michigan, USA. His research interests revolve around the captivating realm of speech processing, with a particular emphasis on topics like Deepfake Detection, Automatic Speaker Verification, and Anti-Spoofing. He aims to enhance security and combat emerging threats within voice-based technologies.',
            researchAreas:"Computer Vision, Multimedia Forensics, DeepFake.",
            links:{ linkedinLink: "https://www.linkedin.com/in/muhammad-umar-farooq-345a7a141/", scholarLink: "", websiteLink:"https://stackoverflow.com/users/7344164/devloverumar"}
        },
    ];
