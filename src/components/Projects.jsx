  ...
  const projectsData = [
    {
      ...
      description: `Disinformation has seen a distinctive rise in recent months, fueled by deepfaked multimedia. From political leaders delivering fabricated speeches to manipulated audio and video in scams, deepfakes pose a significant threat. With research over 6 years and nearly $1M in grants, we developed a deepfake detector. This NSF-PFI and MTRAC funded project seeks to further improve Deep Forgery Detector (DFD) technology. The DFD detects audio-visual forgeries, including various types of deepfakes.`,
